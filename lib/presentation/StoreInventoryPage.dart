...
class StoreinventoryPage extends flutter.StatefulWidget {
  const StoreinventoryPage({flutter.Key? key}) : super(key: key);

  @override
  _StoreinventoryPageState createState() => _StoreinventoryPageState();
}

class _StoreinventoryPageState extends flutter.State<StoreinventoryPage> {
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(child: _buildTextField('جرد المخزن')),
                            const SizedBox(width: 16),
  ...
  Widget _buildDataTable() {
    final columns = [
      ...
      'الخصم',
      'اقل سعر',
      'متوسط سعر الجرد المخزن',
      'اخر سعر الجرد المخزن',
      'تصنيف الصنف'
    ];
      ...
      children: [
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {},
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFFF00AEB9),
              foregroundColor: Colors.white,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
              ),
            ),
            child: const Text('جرد المخزن'),
          ),
        ),
        const SizedBox(height: 16),
        SizedBox(
