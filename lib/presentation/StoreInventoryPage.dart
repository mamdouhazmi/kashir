...
class StoreinventoryPage extends StatefulWidget {
  const StoreinventoryPage({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              for (var tab in ['جرد المخزن', 'Tab 2', 'Tab 3', 'Tab 4'])
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: tab == 'جرد المخزن'
                          ? const Color(0xFF0D99FF)
                          : Colors.white,
                      foregroundColor:
                          tab == 'جرد المخزن' ? Colors.white : Colors.black,
                      elevation: 0,
                      minimumSize: const Size(80, 36),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8),
                        side: BorderSide(
                          color: tab == 'جرد المخزن'
                              ? Colors.transparent
        ...
        child: DataTable(
          ...
          rows: List.generate(
            ...
            (index) => DataRow(
              cells: List.generate(
                10,
                (cellIndex) => const DataCell(Text('Sample')),
              ),
            ),
          ),
        ),
